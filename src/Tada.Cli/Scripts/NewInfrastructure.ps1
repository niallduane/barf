...
dotnet add "./src/4.Presentation/$SOLUTION_NAME.Presentation.Api/$SOLUTION_NAME.Presentation.Api.csproj" reference "./src/2.Infrastructure/$INFRA_NAME/$SOLUTION_NAME.Infrastructure.$INFRA_NAME/$SOLUTION_NAME.Infrastructure.$INFRA_NAME.csproj";
...
dotnet new tada-infra -n "$INFRA_NAME" --nameSpace "$SOLUTION_NAME";
